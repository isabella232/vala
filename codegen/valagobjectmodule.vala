...
public class Vala.GObjectModule : GTypeModule {
	...
	protected void property_to_value (Property prop, CCodeExpression get_prop_func, CCodeExpression cself) {
	...
	protected void property_from_value (Property prop, CCodeExpression set_prop_func, CCodeExpression cself) {
