...
public class Vala.ForeachStatement : Block {
	...
	public override bool check (CodeContext context) {
		...
		} else if (context.profile == Profile.GOBJECT && (collection_type.compatible (context.analyzer.glist_type) || collection_type.compatible (context.analyzer.gslist_type) || collection_type.compatible (context.analyzer.gptrarray_type) || collection_type.compatible (context.analyzer.genericarray_type))) {
